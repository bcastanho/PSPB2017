...
This script produces the descriptives tables (Tables 1 and 5), and the Regression Discontinuity estimates (Table 4). It also prepares the datasets for analysis in R and in Mplus. The other models can be run with the Mplus .inp files found in <https://github.com/bcastanho/PSPB2017/blob/master/Mplus.zip>
